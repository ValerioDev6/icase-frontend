...
export class CrearClienteComponent implements OnInit {
	...
	getPersonaClienteForm() {
		return this.clienteForm.get('id_persona');
	}
	getTipoClienteForm() {
		return this.clienteForm.get('tipo_cliente');
	}

	getEstadoClienteForm() {
		return this.clienteForm.get('estado');
	}

	getClasificacionClienteForm() {
		return this.clienteForm.get('clasificacion');
	}

	getObservacionesClienteForm() {
