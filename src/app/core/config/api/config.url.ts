...
const url: string = 'https://icase-backend.onrender.com/v1/api';
// export const url: string = 'http://localhost:3002/v1/api';
...
export const URL_UPLOAD = `${BASE_URL}/${endpoint.UPLOAD_EXCEL}`;
export const URL_INVENTARIO_ALL = `${BASE_URL}/${endpoint.INVENTARIO}`;
export const URL_AJUSTES_ALL = `${BASE_URL}/${endpoint.RAZONA_AJUSTE}`;
