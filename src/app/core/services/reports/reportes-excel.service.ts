...
export class ReportesExcelService {
	...
	descargarExcelVentas(): Observable<Blob> {
		return this._httpClient.get(`${this.API_URL}/reports-excel/ventas`, {
			responseType: 'blob',
		});
	}
	...
	descargarExcelKardex(): Observable<Blob> {
		return this._httpClient.get(`${this.API_URL}/reports-excel/kardex`, {
			responseType: 'blob',
		});
	}
}
